...
\footnotemark{*?*}\footnotetext{Where to state the advisor?}
...
\footnotetext{In measure theory, this lemma tells $||f-S_Nf||_2 \leq ||f-T_N||_2$}
...
\footnotetext{Symbols defined in \ref{notation}. Probably wrong but why?}
...
\bibitem{Measure} \textsc{M. Capinski, E. Kopp}, \textit{Measure, Integral and Probability}, Springer,
 ...
 \bibitem{History} \textit{N. Jacobs, K. P. Evans} \textit{The Historical Place of Fourier Analysis in Mathematics}, World Scientific, 2018
