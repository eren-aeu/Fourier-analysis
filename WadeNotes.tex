...
\end{remark}\footnotemark{*?*}


\footnotetext{it is given in the Exercises part in 4th section. But accordding to \ref{Dirichlet - Jordan} $S_Nf \to f$ uniformly, not just pointwise. Am I missing something? (it doesnt say $f$ is periodic in the remark, that might be the cause but how?)}
